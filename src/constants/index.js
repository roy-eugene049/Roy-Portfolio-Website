import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      company_name: "TwiiceTech",
      icon: twiicetech,
      iconBg: "#E6DEDD",
      date: "Jan 2021 - Feb 2022",
      points: [
        "Conceptualized and designed print pieces for various organizations",
        "Managed design projects.",
        "Transitioned website to a unified look under a CMS system, improving service to cutomers.",
        "Created 30+ marketing content and social media campaigns to boost company reach through content ideation and implementation schedules",
        "Designed aesthetically-pleasing branding and agent advertising",
      ],
    },
    {
      title: "Software Engineer",
      company_name: "DexxMediaLabs",
      icon: dexxmedialabs,
      iconBg: "#383E56",
  ...
  const testimonials = [
    ...
    {
      testimonial:
        "After Roy optimized our website, our traffic increased by 50%. We can't thank them enough!",
      name: "Lisa Wang",
      designation: "CTO",
